...
async function main() {
  ...
  const notebook = {
    ...
    cells: [
      ...
      md("## 2 · Install dependencies", "_~2 minutes. Torch is already present in Colab._"),
      code(
      ...
      md("## 6 · Load LTX-Video 2B", "_First run downloads the checkpoint (~2–4 min)._"),
      code(
        "import torch",
      ...
      md("## 7 · Generate", "_The actual render. ~3–6 minutes on a T4._"),
      code(
        "import time",
        "",
